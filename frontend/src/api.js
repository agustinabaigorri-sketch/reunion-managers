...
const realApi = {
  ...
  changePasswordAtLogin: (email, currentPassword, newPassword) => req('POST', '/auth/change-password', { email, currentPassword, newPassword }),
  ...
  addRejectReason: (d) => req('POST', '/admin/reject-reasons', d),
  updRejectReason: (id, d) => req('PATCH', '/admin/reject-reasons/' + id, d),
  delRejectReason: (id) => req('DELETE', '/admin/reject-reasons/' + id),
  ...
  okrRejectionsAll: () => req('GET', '/okr/rejections/all'),
  ...
  teamGet: () => req('GET', '/team'),
  teamAdd: (d) => req('POST', '/team', d),
  teamUpd: (id, d) => req('PATCH', '/team/' + id, d),
  teamDel: (id) => req('DELETE', '/team/' + id),
  workGet: () => req('GET', '/work'),
  workMine: () => req('GET', '/work/mine'),
  workAdd: (d) => req('POST', '/work', d),
  workUpd: (id, d) => req('PATCH', '/work/' + id, d),
  workDel: (id) => req('DELETE', '/work/' + id),
